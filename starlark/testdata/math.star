...
# log10
assert.eq(math.log10(10), 1)
assert.eq(math.log10(0.0), -inf)
assert.eq(math.log10(0), -inf)
assert.eq(math.log10(-1.0), nan)
assert.eq(math.log10(-1), nan)
assert.eq(math.log10(nan), nan)
assert.fails(lambda: math.log10("0"), "got string, want float or int")
# log2
assert.eq(math.log2(2), 1)
assert.eq(math.log2(0.0), -inf)
assert.eq(math.log2(0), -inf)
assert.eq(math.log2(-1.0), nan)
assert.eq(math.log2(-1), nan)
assert.eq(math.log2(nan), nan)
assert.fails(lambda: math.log2("0"), "got string, want float or int")
# Constants
