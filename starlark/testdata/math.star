...
assert.eq(math.ceil(-10), -10.0)
assert.eq(math.ceil(float("-inf")), float("-inf"))
assert.fails(lambda: math.ceil("0"), "got string, want a float or an int")
# abs
...
assert.fails(lambda: math.abs("0"), "got string, want a float or an int")
# floor
...
assert.eq(math.floor(-10.0), -10.0)
assert.eq(math.floor(float("-inf")), float("-inf"))
assert.fails(lambda: math.floor("0"), "got string, want a float or an int")
# round
...
assert.eq(math.round(-10.0), -10.0)
assert.eq(math.round(float("-inf")), float("-inf"))
assert.fails(lambda: math.round("0"), "got string, want a float or an int")
# exp
...
assert.fails(lambda: math.exp("0"), "got string, want a float or an int")
# sqrt
...
assert.fails(lambda: math.sqrt("0"), "got string, want a float or an int")
# acos
...
assert.fails(lambda: math.acos("0"), "got string, want a float or an int")
# asin
...
assert.fails(lambda: math.asin("0"), "got string, want a float or an int")
# atan
...
assert.fails(lambda: math.atan("0"), "got string, want a float or an int")
# atan2
...
assert.eq(math.atan2(float("-inf"), float("-inf")), -3 * math.pi / 4)
assert.fails(lambda: math.atan2("0", 1.0), "got string, want a float or an int")
assert.fails(lambda: math.atan2(1.0, "0"), "got string, want a float or an int")
# cos
...
assert.fails(lambda: math.cos("0"), "got string, want a float or an int")
# hypot
...
assert.fails(lambda: math.hypot("0", 1.0), "got string, want a float or an int")
assert.fails(lambda: math.hypot(1.0, "0"), "got string, want a float or an int")
# sin
...
assert.fails(lambda: math.sin("0"), "got string, want a float or an int")
# tan
...
assert.fails(lambda: math.tan("0"), "got string, want a float or an int")
# degrees
...
assert.fails(lambda: math.degrees("0"), "got string, want a float or an int")
# radians
...
assert.fails(lambda: math.radians("0"), "got string, want a float or an int")
# acosh
...
assert.fails(lambda: math.acosh("0"), "got string, want a float or an int")
# asinh
...
assert.fails(lambda: math.asinh("0"), "got string, want a float or an int")
# atanh
...
assert.fails(lambda: math.atanh("0"), "got string, want a float or an int")
# cosh
...
assert.fails(lambda: math.cosh("0"), "got string, want a float or an int")
# sinh
...
assert.fails(lambda: math.sinh("0"), "got string, want a float or an int")
# tanh
...
assert.fails(lambda: math.tanh("0"), "got string, want a float or an int")
